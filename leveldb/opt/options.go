...
var (
	...
	DefaultCompactionTotalSize           = 10 * MiB // default (N levels)
...
// KIR
func (o *Options) SetBeta(alpha float64) {
	Beta = alpha
}

func (o *Options) GetBeta() float64 {
	return Beta
}

func (o *Options) EnableParallelComp() {
	atomic.StoreInt32(&DoParallelComp, 1)
}

func (o *Options) DisableParallelComp() {
	atomic.StoreInt32(&DoParallelComp, 0)
}

func (o *Options) GetParallelCompOption() int32 {
	return atomic.LoadInt32(&DoParallelComp)
}

func (o *Options) EnableRO() {
	atomic.StoreInt32(&DoRO, 1)
}

func (o *Options) DisableRO() {
	atomic.StoreInt32(&DoRO, 0)
}

func (o *Options) GetRO() int32 {
	return atomic.LoadInt32(&DoRO)
}
